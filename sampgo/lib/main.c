 ...
 */
PLUGIN_EXPORT bool PLUGIN_CALL OnPlayerEditAttachedObject(int playerid, int response, int index, int modelid, int boneid, float* floats)
{
    onPlayerEditAttachedObject(playerid, response, index, modelid, boneid, floats);
    return true;
}
